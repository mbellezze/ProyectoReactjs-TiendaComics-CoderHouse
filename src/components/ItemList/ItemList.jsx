...
export const ItemList = () => {
    ...
    const filterComics = dataComics => {
        return filter === '' ? dataComics : dataComics.filter(element => element.comic === comicID);
    }
        ...
        (<Grid container>
            <Grid item xs={12}>
                <Grid container justify="center">
                    {filterComics(baseComics).map((element, id) => <Item key={id} {...element}/>)}
                </Grid>
            </Grid>
        </Grid>)
        }
